import { Poke, Scry, dejs } from '@urbit/http-api';
import { Belt, Task } from './types';
...
export const pokeTask = (session: string, task: Task): Poke => {
  let non: any = 0;
  if ('belt' in task) {
    // [%belt p=belt]
